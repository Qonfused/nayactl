...
LED_SET_SCANMODE_PWM  = 0x1012
LED_SET_MAX_BRIGHTNESS= 0x1013
LED_SET_LAYER_OVERRIDE= 0x1014
LED_FORCE_ON          = 0x10D1
...
LED_NAMES = {
  ...
  LED_SET_SCANMODE_PWM:   "SET_SCANMODE_PWM",
  LED_SET_MAX_BRIGHTNESS: "SET_LED_MAX_BRIGHTNESS",
  LED_SET_LAYER_OVERRIDE: "SET_LED_LAYER_OVERRIDE",
  LED_RED:               "LEDs_RED",
